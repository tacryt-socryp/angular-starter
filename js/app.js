...
},{"../components/components.js":2,"../layout/layout.js":4,"../pages/pages.js":12,"angular":6,"angular-ui-router":5}],2:[function(require,module,exports){
module.exports = function (ngModule) {
    require("./la-input/la-input.js")(ngModule);
};

},{"./la-input/la-input.js":3}],3:[function(require,module,exports){
module.exports = function (ngModule) {
...
},{"./lib/angular.js":7}],7:[function(require,module,exports){
/**
...
module.exports = [
  "$scope",
  function($scope) {
    $scope.homeText = "Hackathon Starter.";
  }
];
...
},{"./controllers/home.ctrl.js":9,"./templates/home.jade":11}],11:[function(require,module,exports){
...
buf.push("<article><h2>{{ homeText }}</h2><h3>{{ homeText }}</h3><h4>{{ homeText }}</h4><h5>{{ homeText }}</h5><h6>{{ homeText }}</h6><p>{{ homeText }}</p></article>");;return buf.join("");
};
